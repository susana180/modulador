...
set ::env(CLOCK_NET) "OQPSK_PS_RCOSINE2.CLK"
...
set ::env(FP_PDN_MACRO_HOOKS) "\
	OQPSK_PS_RCOSINE2 vdd vss vdd vss"
...
set ::env(VERILOG_FILES_BLACKBOX) "\
	$::env(CARAVEL_ROOT)/verilog/rtl/defines.v \
	$::env(DESIGN_DIR)/../../verilog/rtl/OQPSK_PS_RCOSINE2.v"

set ::env(EXTRA_LEFS) "\
	$::env(DESIGN_DIR)/../../lef/OQPSK_PS_RCOSINE2.lef"

set ::env(EXTRA_GDS_FILES) "\
	$::env(DESIGN_DIR)/../../gds/OQPSK_PS_RCOSINE2.gds"
